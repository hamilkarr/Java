...
public class Book {
	...
	public Book(String bookNumSign, int bookNumber, String bookName, String author, String publisher, boolean checkOut,
			String callNumber) {
	...
	public String toString() {
		return bookNumSign + bookNumber + "   |    " + bookName + "   |    " + author + "   |    " + publisher + "   |    "
				+ checkOut + "   |    " + callNumber;
	}
}
